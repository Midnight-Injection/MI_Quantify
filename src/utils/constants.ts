...
export const DATA_SOURCE_PRESETS: Omit<DataSource, 'apiKey' | 'apiSecret'>[] = [
  { id: 'akshare', name: 'AkShare（免费）', enabled: true, type: 'free', apiUrl: PYTHON_SIDECAR_URL, priority: 1 },
  { id: 'baostock', name: 'BaoStock（免费）', enabled: true, type: 'free', apiUrl: PYTHON_SIDECAR_URL, priority: 2 },
  { id: 'easyquotation', name: '实时行情（免费）', enabled: true, type: 'free', apiUrl: PYTHON_SIDECAR_URL, priority: 1 },
  { id: 'tushare', name: 'Tushare Pro', enabled: false, type: 'paid', apiUrl: 'https://api.tushare.pro', priority: 3 },
  { id: 'eastmoney', name: '东方财富', enabled: true, type: 'free', apiUrl: PYTHON_SIDECAR_URL, priority: 1 },
  { id: 'sina', name: '新浪财经', enabled: true, type: 'free', apiUrl: PYTHON_SIDECAR_URL, priority: 2 },
]
